...
### Indexing Errors
Indexing erros happen when you call a row or column of a data frame that the data frame doesn't have.
...
* Check the line for syntax mistakes like missing parenthesis 
