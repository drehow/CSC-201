...
(show photos of different raw file content types and one with extension .data but is actually a csv)

### File Paths
File paths provide a map to where your file is stored in the computer. With each successive "\\" in Windows or "/" in Mac oS, the file path is going deeper and deeper into subfolders. File paths can be frustrating because you have to get them exactly right for R to be able to access your data
